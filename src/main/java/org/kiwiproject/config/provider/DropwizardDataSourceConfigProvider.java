...
public class DropwizardDataSourceConfigProvider implements ConfigProvider {
    ...
    private static final Map<String, Map<String, String>> DEFAULTS_FOR_PROPERTIES = Map.of(
            DRIVER_CLASS_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_DRIVER_CLASS_SYSTEM_PROPERTY, ENV_PROPERTY, DEFAULT_DRIVER_CLASS_ENV_VARIABLE,
                    EXTERNAL_PROPERTY, DEFAULT_DRIVER_CLASS_EXTERNAL_PROPERTY_KEY),
            URL_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_URL_SYSTEM_PROPERTY, ENV_PROPERTY, DEFAULT_URL_ENV_VARIABLE,
                    EXTERNAL_PROPERTY, DEFAULT_URL_EXTERNAL_PROPERTY_KEY),
            USER_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_USER_SYSTEM_PROPERTY, ENV_PROPERTY, DEFAULT_USER_ENV_VARIABLE,
                    EXTERNAL_PROPERTY, DEFAULT_USER_EXTERNAL_PROPERTY_KEY),
            PASSWORD_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_PASSWORD_SYSTEM_PROPERTY, ENV_PROPERTY, DEFAULT_PASSWORD_ENV_VARIABLE,
                    EXTERNAL_PROPERTY, DEFAULT_PASSWORD_EXTERNAL_PROPERTY_KEY),
            MAX_SIZE_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_MAX_SIZE_SYSTEM_PROPERTY, ENV_PROPERTY,
                    DEFAULT_MAX_SIZE_ENV_VARIABLE, EXTERNAL_PROPERTY, DEFAULT_MAX_SIZE_EXTERNAL_PROPERTY_KEY),
            MIN_SIZE_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_MIN_SIZE_SYSTEM_PROPERTY, ENV_PROPERTY, DEFAULT_MIN_SIZE_ENV_VARIABLE,
                    EXTERNAL_PROPERTY, DEFAULT_MIN_SIZE_EXTERNAL_PROPERTY_KEY),
            INITIAL_SIZE_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_INITIAL_SIZE_SYSTEM_PROPERTY, ENV_PROPERTY, DEFAULT_INITIAL_SIZE_ENV_VARIABLE,
                    EXTERNAL_PROPERTY, DEFAULT_INITIAL_SIZE_EXTERNAL_PROPERTY_KEY),
            ORM_PROPERTIES_FIELD, Map.of(SYSTEM_PROPERTY, DEFAULT_ORM_PROPERTIES_SYSTEM_PROPERTY, ENV_PROPERTY, DEFAULT_ORM_PROPERTIES_ENV_VARIABLE, EXTERNAL_PROPERTY,
    ...
    private DropwizardDataSourceConfigProvider(ExternalConfigProvider externalConfigProvider,
        ...
        resolvedProperties.putAll(originalFactory.getProperties());
        dataSourceFactory.setProperties(resolvedProperties);
    }
